...
Selected list of publications and presentations in human-AI interaction and safety-critical automation. The full list is available in my [CV](docs/resume-cv-Davide-Gentile.pdf).

### Peer reviewed

-   **Gentile D.**, Donmez, B., & Jamieson, G. A. (2025). Human performance effects of combining counterfactual explanations with normative and contrastive explanations in supervised machine learning for automated decision assistance. *International Journal of Human-Computer Studies*, 196, 103434. [Link](https://www.sciencedirect.com/science/article/pii/S1071581924002179)
...
-   Lawson-Jack K., **Gentile D.**, & Jamieson, G. A. (2025). Towards a Taxonomy of Heterogeneity in the Design of Small Modular Reactors and Implications for Human Performance. In the *14th International Topical Meeting on* *Nuclear Plant Instrumentation and Control & Human-Machine Interface Technology (NPIC*

### In preparation

-   **Gentile D.**, & Jamieson, G. A. (2025). Human factors challenges in artificial intelligence regulation for nuclear safety.

-   **Gentile D.**, & Jamieson, G. A. (2025). Exploring the effects of transparency strategies on human performance in automated nuclear operations.

-   **Gentile D.**, Jamieson, G. A., & Donmez B. (2023). Influence of Individual Differences on the Effectiveness of Post-hoc Explanations in Automation Reliance Behavior. *Journal of Cognitive Engineering and Decision-Making*.
