---
title: "Machine Learning Models Evaluation for Usage-based Insurance"
author: "Davide Gentile"
description: "Utilized fleet telematics data to improve usage-based insurance models by analyzing driving behaviors and collision risks. Machine learning algorithms assessed factors like trip frequency and speed changes, providing fleet rental companies with data-driven insights to adjust insurance rates based on risky driving behaviors."
date: "2024-08-24"
image: "picture4.png"
categories: [Collision risk modeling, data science]
execute:
  warning: false
---
